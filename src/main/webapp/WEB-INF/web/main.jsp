		...
		<div id="page-wrapper">
			...
			alt="Responsive image" style="width: 100%; height: 700px"> --%>
					<video id="mainvideo" width="100%" height="100%" loop="loop"
						autoplay="autoplay"
						style="margin-top: 0; padding-top: 0; opacity: 0.8; position: relative;">
						<source
					...
					<div
						...
						<img
							...
							style="color: white; font-weight: bold; font-size: 15pt ;top 24px; position: absolute;">발자국</span>
					</div>
					<!-- 메인 우측 상단  -->
								...
								<div class="col-lg-8 col-md-4 col-sm-6 item"
									...
									<p style="text-align: center">
										<span class="mainmsg"
											...
											나만의 여행 발자취</span>
									<div class="input-group navbar-form navbar-nav"">
										<form
											action="${pageContext.request.contextPath }/map/search.do"
											method="get">
											<input type="text" class="form-control"
												placeholder="원하시는 여행지를 입력해 주세요" id="searchtext"
												style="font-size: 16pt; margin-top: 13px; background-color: transparent; height: 50px"
												onkeypress="if (event.keyCode==13){ goSearch();event.returnValue=false}">
										</form>
										&nbsp;&nbsp;&nbsp; <span class="input-group-btn"><a
											href="javascript:goSearch()" class="hdr-btn">&nbsp;&nbsp;&nbsp;<i
												class="glyph-icon icon-search"
												style="color: white; font-size: 42px"></i></a></span>
									</div>
									<div class="col-lg-8 col-md-4 col-sm-6 item"
			...
			<h3 style="color: white;">present and future adventures. It's free!</h3> -->
				...
				<button class="dropdown-item btn btn-primary" type="button" 
					...
					GET STARTED
						...
						<!-- 사이트 소개 -->
						<div
							style="position: absolute; left: 0; right: 0; bottom: -270px; background: 0">
							<div class="container">
								<div class="intro"></div>
								<div class="row  features">
