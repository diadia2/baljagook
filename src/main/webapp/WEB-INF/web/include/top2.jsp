						...
						$
								.ajax({
									...
									success : function(imageName) {
										$("#profileImage").prop(
												"src",
												"${ pageContext.request.contextPath }/resources/photo/profileImage/"
														+ imageName);
									}
								});
...
<body>
	...
	<div id="page-header">
		<div id="header-nav-left">
			<label><span id="alarm"></span> </label>&nbsp;&nbsp; <a
				class="header-btn" id="logout-btn" href="lockscreen-3.html"
			...
			<div class="user-account-btn dropdown">
				<a href="#" title="My Account" class="user-profile clearfix"
					data-toggle="dropdown"><img id="profileImage" width="28"
					height="28"
				...
				<ul class="dropdown-menu" role="menu" style="display: none;">
					...
					<c:if test="${not empty sessionScope.user }">
						<li><a
							href="${pageContext.request.contextPath }/member/mypage.do"><i
								class="fa fa-user"></i>&nbsp;&nbsp;MyPage</a></li>
						<li class="divider"></li>
		...
		<div id="header-nav-right" class="row">
			<div class="col-md-4">
				<a class="navbar-brand"
					href="${pageContext.request.contextPath }/main.do">발자국로고자리</a>
			</div>
			<div class="col-md-4">
				<div class="input-group" id="searchvar">
					<form action="${pageContext.request.contextPath }/map/search.do"
						...
						<input type="text" class="form-control" placeholder="Search"
							id="searchtext" style="margin-top: 13px;"
