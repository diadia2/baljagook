												...
												<div id="tabs-example-1" style="height: 100%"> 
													...
													<div class="row" >
														<span class="col-md-1" draggable="true"
															...
															src="https://developers.skplanetx.com/upload/tmap/marker/pin_b_m_a.png" title="지도에 드래그하여 마커를 추가하세요"/></span>
														<div class="col-md-9">
													...
													<input id="title" name="title" type="text" class="form-control"
														placeholder="제목"> <br /> <input id="content" name="content"
														type="text" class="form-control" placeholder="설명">
													<!-- pannel -->
													<div class="cf clearfix nestable-lists" style="overflow: hidden; overflow-y: auto; height:100%">
																	...
																	<ul>
																		<c:forEach var="mymapListPlanAndReg" items="${ mymapListPlanAndReg }">
																			<c:if test="${ mymapListPlanAndReg.type == 1 }">
																				<li><a href="javascript:mymapListPlanAndReg('${ mymapListPlanAndReg.idx }')"
																				style="text-decoration: none;"><span style="font-size: 13pt;">${ mymapListPlanAndReg.title }</span></a></li>
																			</c:if>
																		</c:forEach>
																	</ul>
																	</div>
																...
																<div id="collapseThree" class="panel-collapse collapse">
																	...
																	<ul>
																		<c:forEach var="mymapList" items="${ mymapList }">
																			<li><a href="javascript:getMymap('${ mymapList.idx }')"
																				style="text-decoration: none;"><span style="font-size: 13pt;">지도 : ${ mymapList.title }</span></a></li>
																		</c:forEach>
																		<c:forEach var="favoriteplaceList"
																			items="${ favoriteplaceList }">
																			<li><a href="javascript:getMyplace('${ favoriteplaceList.checkpointidx }')"
																				style="text-decoration: none;"><span style="font-size: 13pt;">장소 : ${ favoriteplaceList.placename }</span></a></li>
																		</c:forEach>
																	</ul>
																	</div>
																</div>
