				...
				<div class="row">
					<div class="col-md-3">
						<ul class="list-group">
							<c:forEach var="faqList" items="${ faqList }" varStatus="i">
								<li class="mrg10B"><a href="#faq-tab-${ i.index + 1 }" data-toggle="tab" class="list-group-item bg-white">${ faqList.title } 
					...
					<div class="col-md-9">
						<div id="allfaq" class="tab-content">
							<c:forEach var="faqList" items="${ faqList }" varStatus="i"> 
								<c:if test="${ i.index == 0 }">
									<div class="tab-pane fade active in pad0A" id="faq-tab-${ i.index + 1 }">
										<div class="panel-group" id="accordion5">
											<div class="panel">
												...
												<div id="collapseOne${ i.index }" class="panel-collapse collapse in">
